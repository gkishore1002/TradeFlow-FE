        ...
        <button
          ...
          className={`w-full px-3 py-2 text-left bg-white border border-slate-300 rounded-lg shadow-sm font-medium text-slate-900 transition-all duration-200 flex items-center justify-between text-sm ${
            disabled
              ...
              : "cursor-pointer hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3b82f6] focus:ring-offset-0"
          } ${isOpen ? "ring-2 ring-[#3b82f6]" : ""}`}
        >
          <span
            className={`truncate ${!selectedOption ? "text-slate-400" : "text-slate-900"}`}
          >
            ...
            {searchable && (
              <div className="px-3 py-2 border-b border-slate-200 bg-slate-50">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-[#3b82f6] text-slate-900 placeholder-slate-600 bg-white"
                />
              </div>
            )}
              ...
              {filteredOptions.length > 0 ? (
                filteredOptions.map((option, index) => (
                  ...
                  >
                    ...
                    {String(selectedOption?.value) === String(option.value) && (
                      <svg
                        className="w-4 h-4 text-[#3b82f6] flex-shrink-0 ml-2"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
