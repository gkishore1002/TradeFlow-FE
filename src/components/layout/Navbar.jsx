...
// Moved from src/app/dashboard/Navbar.jsx
...
const Navbar = ({
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/notifications?per_page=5&sort_order=desc`, {
                headers: {
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 md:gap-4 min-w-0">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0 hover:opacity-80 transition-opacity cursor-pointer"
                                            ...
                                            <div className="divide-y divide-slate-100">
                                                {notifications.map((notification) => (
                                                    <button
                                                        ...
                                                        className={`w-full p-4 hover:bg-slate-50 transition-colors text-left ${!notification.is_read ? 'bg-blue-50' : ''
                                                            }`}
                                                    >
                                    ...
                                    <div className="py-1">
                                        {menuItems.map((item, index) => (
                                            <button
                                                key={item.id}
                                                onClick={item.action}
                                                className={`w-full flex items-center gap-3 px-4 sm:px-5 py-2.5 sm:py-3 text-sm font-medium transition-colors duration-200 ${item.isDanger
