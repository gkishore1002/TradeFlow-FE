    ...
    general: [
      {
        ...
        answer:
          "TradeFlow is a trading journal and analysis platform to help traders track and improve their trading performance.",
      },
      {
        id: 2,
        question: "How do I create a trade entry?",
        answer:
          "Go to 'My Journal', click 'Add New Trade', and fill in entry price, exit price, quantity, and strategy notes.",
      },
      {
        id: 3,
        question: "Can I export my data?",
        answer:
          "Export functionality is coming in the next update. Currently available for viewing within the platform.",
      },
      {
        id: 4,
        question: "Is my data secure?",
        answer:
          "Yes, all data is encrypted and stored securely with industry-standard security protocols.",
      },
    ],
    account: [
      {
        ...
        answer:
          "Click profile icon, select 'Profile', then 'Change Password' and follow the instructions.",
      },
      {
        id: 6,
        question: "Can I delete my account?",
        answer:
          "Yes, you can delete your account from profile settings. This action is permanent and cannot be undone.",
      },
      {
        id: 7,
        question: "How do I update profile?",
        answer:
          "Go to 'Profile', click 'Edit Profile', make changes, and click 'Save Changes'.",
      },
    ],
    trading: [
      {
        ...
        answer:
          "View overall statistics on the Dashboard. Visit 'Success Logs' to review individual trades.",
      },
      {
        id: 9,
        question: "What strategies can I track?",
        answer:
          "You can create and track any trading strategy from 'My Strategies' section.",
      },
      {
        id: 10,
        question: "How do I use Pre Trade Analysis?",
        answer:
          "Plan trades before execution. Document setup, entry points, and exit targets.",
      },
    ],
    billing: [
      {
        ...
        answer:
          "TradeFlow offers a free tier with basic features. Premium features coming soon.",
      },
      {
        id: 12,
        question: "What payment methods?",
        answer:
          "We accept major credit cards and PayPal. Payment integration available with premium launch.",
      },
    ],
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="md:col-span-3">
                  ...
                  {filteredFaqs.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {filteredFaqs.map((faq, idx) => (
                        <div
                          key={idx}
                          className="group bg-white rounded-lg border border-slate-200 overflow-hidden hover:border-[#3b82f6]/50 hover:shadow-sm transition-all duration-300"
                        >
                          <details
                            key={faq.id}
                            className="group bg-white rounded-lg border border-slate-200 overflow-hidden hover:border-[#3b82f6]/50 hover:shadow-sm transition-all duration-300"
                    ...
                    <div className="text-center py-8 sm:py-12">
                      <svg
                        className="w-12 h-12 sm:w-16 sm:h-16 text-slate-300 mx-auto mb-2 sm:mb-4"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" />
                ...
                <div className="bg-white rounded-lg shadow-sm border border-slate-100 overflow-hidden">
                  {/* Header */}
                  <div className="px-4 sm:px-6 md:px-8 py-4 sm:py-6 bg-[#3b82f6]">
                      ...
                      <div
                        ...
                        className={`flex items-start gap-3 ${
                          index !== contactDetails.length - 1
                            ? "pb-3 sm:pb-4 border-b border-slate-200"
                            : "pb-0"
                        }`}
                      >
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-[#3b82f6] flex-shrink-0 mt-0.5"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                          {detail.type === "Email" && (
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {detail.href ? (
                            <a
                              href={detail.href}
                              className="text-xs sm:text-sm text-[#3b82f6] hover:text-[#2563eb] hover:underline break-all transition-colors"
                            >
                              {detail.value}
                            </a>
                          ) : (
                  ...
                  {/* Footer Message */}
                  <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-[#3b82f6]/10 border-t border-slate-200 flex items-start gap-2">
                    <svg
                    ...
                    <p className="text-xs sm:text-sm text-slate-700">
                      <span className="font-semibold">Tip:</span> Email us for
                      detailed support. We typically respond within 24 hours.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 sm:mt-8 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
                  ...
                  <p className="text-green-800 font-medium text-xs sm:text-sm">
                    Found what you're looking for? Great! If you need further
                    assistance, don't hesitate to contact our support team.
                  </p>
                </div>
              </div>
            </div>
