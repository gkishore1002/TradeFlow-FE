            ...
            <div className="block md:hidden divide-y divide-slate-100">
              {notifications.map((notification) => (
                <div
                  ...
                  className={`p-4 cursor-pointer hover:bg-slate-50 transition-colors ${!notification.is_read ? "bg-blue-50 border-l-4 border-l-blue-500" : ""}`}
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <div className="flex-1 min-w-0">
                      <h3
                        className={`text-sm font-medium text-slate-900 mb-1 ${!notification.is_read ? "font-semibold" : ""}`}
                      >
                        {notification.title}
                      </h3>
                  ...
                  {notifications.map((notification) => (
                    <tr
                      ...
                      onClick={() => {
                        if (notification.link) {
                          ...
                          let matchedTab = null;
                          for (const [alias, tabId] of Object.entries(
                            tabMapping,
                          )) {
                            if (link.includes(alias)) {
                              matchedTab = tabId;
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <p
                          className={`text-sm text-slate-900 ${!notification.is_read ? "font-semibold" : "font-medium"}`}
                        >
                          {notification.title}
                        </p>
                      </td>
